...
AISHELL3_DOWNLOAD_PATH = '/mnt/md1/user_wago/data/aishell3'
...
md_config = BaseDatasetConfig(
    ...
    meta_file_train= "/mnt/md1/user_wago/MOS/csv/mandarin_drama_95hr_sub_select_subset_34hr_with_pinyin_weight.csv",
    # meta_file_train="mandarin_drama_95hr_sub_select_text_with_pinyin_dict_with_loss_weight_weight_8.373754501342773.csv",
    # meta_file_train="mandarin_drama_95hr_sub_select_text_with_pinyin_dict_with_loss_weight_weight_3.csv",
    meta_file_val="",
    path=MD_DOWNLOAD_PATH,
    language="ma",
)

aishell3_config = BaseDatasetConfig(
    formatter="aishell3_self",
    ...
    # meta_file_train="mandarin_drama_95hr_sub_select_text_with_pinyin_dict_with_loss_weight_weight_8.373754501342773.csv",
    meta_file_train="/mnt/md1/user_wago/data/src/aishell3_train_len_free_select_3.5_len_free_pinyin_weight_8.373754501342773_16k.csv",
    meta_file_val="",
    path=AISHELL3_DOWNLOAD_PATH,
    language="ma",
)
...
DATASETS_CONFIG_LIST = [aishell3_config, md_config]
...
config = VitsConfig(
    ...
    test_sentences=[
        [
            ...
            # 一 号 等 小 号 码 通 常 属 于 踢 球 手
            "yi1 hao4 deng3 xiao3 hao4 ma3 tong1 chang2 shu3 yu2 ti1 qiu2 shou3",
            "SSB02880083",
            None,
            "ma",
        ],
        [
            ...
            # "'gui4', 'bin1', 'jiu3', 'lou2'",
            # 所以每個人收兩百塊
            # "'S', 'U', 'O', '3', 'Y', 'I', '3', 'M', 'EI', '3', 'G', 'E', '5', 'R', 'EN', '2', 'SH', 'OU', '1', 'L', 'I', 'ANG', '3', 'B', 'AI', '3', 'K', 'U', 'AI', '4'",
            # 在我還沒有確定
            "zai4 wo3 hai2 mei2 you3 que4 ding4",
            "WTqlEt-P0LQ_1659793-1661260",
            None,
            "ma",
        ],
        [
            ...
            # 那記得你的傷口回去呀
            # "'N', 'A', '4', 'J', 'I', '4', 'D', 'E', '5', 'N', 'I', '3', 'D', 'E', '5', 'SH', 'ANG', '1', 'K', 'OU', '3', 'H', 'UI', '2', 'Q', 'V', '4', 'Y', 'A', '5'",
            # "vGedcXb7i8g_1152326-1153759",
            # 是要買拜拜的貢品
            "shi4 yao4 mai3 bai4 bai4 de5 gong4 pin3",
            "fRxUv9vC4ao_0239379-0241046",
            None,
            "ma",
        ],
        [
            ...
            # 安徽芜湖一餐馆儿煤气瓶爆炸一七人亡
            "an1 hui1 wu2 hu2 yi1 can1 guanr3 mei2 qi4 ping2 bao4 zha4 yi1 qi1 ren2 wang2",
            "SSB02880083",
            None,
            "ma",
        ],
        [
            ...
            # 我们会尽最大努力使得操作简单化
            "wo3 men5 hui4 jin4 zui4 da4 nu3 li4 shi3 de5 cao1 zuo4 jian3 dan1 hua4",
            "SSB02880308",
            None,
            "ma",
        ],
