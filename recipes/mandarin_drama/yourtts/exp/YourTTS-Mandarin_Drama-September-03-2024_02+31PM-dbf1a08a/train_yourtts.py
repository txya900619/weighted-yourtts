...
md_config = BaseDatasetConfig(
    ...
    meta_file_train="mandarin_drama_95hr_sub_select_text_with_pinyin_dict.csv",
    meta_file_val="",
...
config = VitsConfig(
    ...
    test_sentences=[
        [
            ...
            "/mnt/md1/user_wago/data/mandarin_drama/trimmed_wav_0/pnUnvpYkQeU/pnUnvpYkQeU_0567502-0569502.wav",
            None,
            "ma",
        ],
        [
            ...
            "/mnt/md1/user_wago/data/mandarin_drama/trimmed_wav_0/tE_a4prlOSk/tE_a4prlOSk_1253102-1254269.wav",
            None,
            "ma",
        ],
        [
            ...
            "/mnt/md1/user_wago/data/mandarin_drama/trimmed_wav_0/pnUnvpYkQeU/pnUnvpYkQeU_0525235-0527968.wav",
            None,
            "ma",
        ],
        [
            ...
            "/mnt/md1/user_wago/data/mandarin_drama/trimmed_wav_0/rCZPbHep0xQ/rCZPbHep0xQ_1020878-1022244.wav",
            None,
            "ma",
        ],
        [
