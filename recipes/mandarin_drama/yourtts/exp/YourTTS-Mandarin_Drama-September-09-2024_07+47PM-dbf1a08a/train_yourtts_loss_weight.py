...
md_config = BaseDatasetConfig(
    ...
    meta_file_train= "/mnt/md1/user_wago/data/mandarin_drama/mandarin_drama_95hr_sub_select_text_with_pinyin_dict_with_loss_weight_weight_4.csv",
...
aishell3_config = BaseDatasetConfig(
    ...
    # meta_file_train="mandarin_drama_95hr_sub_select_text_with_pinyin_dict_with_loss_weight_weight_8.373754501342773.csv",
    meta_file_train="/mnt/md1/user_wago/data/aishell3/aishell3_train_subset_7hr_len_free_select_3.75_pinyin_weight_alpha_8.373754501342773.csv",
    meta_file_val="",
