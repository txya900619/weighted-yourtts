...
md_config = BaseDatasetConfig(
    ...
    meta_file_train= "/mnt/md1/user_wago/data/mandarin_drama/mandarin_drama_95hr_sub_select_text_with_pinyin_dict_with_loss_weight_weight_4_with_phone.csv",
...
aishell3_config = BaseDatasetConfig(
    ...
    # meta_file_train="mandarin_drama_95hr_sub_select_text_with_pinyin_dict_with_loss_weight_weight_8.373754501342773.csv",
    meta_file_train="/mnt/md1/user_wago/data/aishell3/aishell3_train_subset_7hr_len_free_g2pw_pinyin_weight_4_with_phone_16k.csv",
    meta_file_val="",
...
config = VitsConfig(
    ...
    test_sentences=[
        [
            ...
            "'B', 'U', '2', 'G', 'U', 'O', '4', 'N', 'I', '3', 'SH', 'ANG', '4', 'B', 'U', '2', 'SH', 'I', '4', 'Y', 'OU', '3', 'Y', 'VE', '1', 'L', 'E', '5', 'SH', 'EN', '2', 'M', 'E', '5'"
            "SSB15750142",
            None,
            "ma",
        ],
        ...
        [
            ...
            "'K', 'AN', '4', 'Q', 'I', '3', 'L', 'AI', '2', 'T', 'E', '4', 'L', 'I', '3', 'P', 'I', '2', 'X', 'I', 'AN', '1', 'SH', 'ENG', '1', 'B', 'A', '3', 'J', 'IU', '3'",
            "SSB15750416",
            None,
            "ma",
        ],
        [
            ...
            "'D', 'E', '2', 'G', 'U', 'O', '2', 'D', 'E', '5', 'W', 'ANG', '2', 'P', 'AI', '2', 'F', 'EI', '1', 'X', 'ING', '2', 'Y', 'V', 'AN', '2', 'Y', 'OU', '3', 'SH', 'EN', '2', 'M', 'E', '5'",
            "SSB15750142",
            None,
            "ma",
        ],
