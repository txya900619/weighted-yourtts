...
if not os.path.exists(AISHELL3_DOWNLOAD_PATH):
...
md_config = BaseDatasetConfig(
    ...
    meta_file_train="train/label_train-set.txt",
    meta_file_val="",
...
config = VitsConfig(
    ...
    run_description="""
            - Original YourTTS trained using aishell3 dataset
        """,
